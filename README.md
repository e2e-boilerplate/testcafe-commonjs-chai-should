...
## Getting Started
    	...
    	1. git clone git@github.com:e2e-boilerplate/testcafe-commonjs-chai-expect.git
    	2. cd testcafe-commonjs-chai-expect
    	3. npm install
    	4. npm run test
